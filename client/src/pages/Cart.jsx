...
const Cart = () => {
  ...
  const PlaceOrder = async ()=> {
    // Previously navigated to a payment page; restored to direct order confirmation.
    // TODO: integrate real order creation; for now navigate to orders page.
    navigate('/my-orders', { state: { paymentOption, selectedAddress, cartArray, amount: getCartAmount() } });
    scrollTo(0,0);
  }
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddress  ? `${selectedAddress.street}, ${selectedAddress.city}, ${setAddresses.state}, ${selectedAddress.country}` : "No address found"}</p>
