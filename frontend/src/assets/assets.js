...
import Spices_Essentials from "./Spices_Essentials.png";
import hairoil from "./hairoil.png";
import shampoo from "./shampoo.png";
import dishwashing_liquid from "./dishwashing_liquid.png";
import detergent from "./detergent.png";
import toothpaste from "./toothpaste.png";
import redchilli_powder from "./redchilli_powder.png";
import turmeric_powder from "./turmeric_powder.png";
import cloves from "./cloves.png";
import black_pepper from "./black_pepper.png";
...
export const categories = [
  ...
  {
    text: "Spices & Essentials",
    path: "SpicesEssentials",
    image: Spices_Essentials,
    bgColor: "#FEE0E0",
  },
  {
    text: "Cold Drinks",
...
export const dummyProducts = [
  // Household
 {
  ...
  description: [
    ...
    "Enriched with natural coconut oil"
  ],
...
},
{
  ...
  description: [
    ...
    "Refreshing fragrance for long-lasting freshness"
  ],
  createdAt: "2025-03-25T07:17:46.018Z",
  updatedAt: "2025-03-25T07:18:13.103Z",
  inStock: true,
...
},
{
  ...
  description: [
    ...
    "Gentle on fabrics while deep cleaning"
  ],
  createdAt: "2025-03-25T07:17:46.018Z",
  updatedAt: "2025-03-25T07:18:13.103Z",
  inStock: true,
...
},
{
  ...
  price: 110,
  offerPrice: 95,
  image: [dishwashing_liquid],
  description: [
    "Cuts through grease and oil easily",
    "Leaves utensils sparkling clean",
    "Pleasant lemon fragrance",
    "Concentrated formula for more washes"
  ],
  createdAt: "2025-03-25T07:17:46.018Z",
  updatedAt: "2025-03-25T07:18:13.103Z",
  inStock: true,
...
},
{
  ...
  description: [
    ...
    "Supports strong and healthy teeth"
  ],
  createdAt: "2025-03-25T07:17:46.018Z",
  updatedAt: "2025-03-25T07:18:13.103Z",
  inStock: true,
  ...
  description: [
    ...
    "Ideal for curries and everyday cooking",
    "Contains natural antioxidants",
    "Finely ground for smooth blending"
  ],
  createdAt: "2025-03-25T07:17:46.018Z",
  updatedAt: "2025-03-25T07:18:13.103Z",
  inStock: true,
...
},
{
  ...
  price: 95,
  offerPrice: 85,
  image: [redchilli_powder],
  description: [
    "Adds rich color and spicy flavor",
    "Made from carefully selected chillies",
    "Perfect for Indian and Asian dishes",
...
},
{
  ...
  image: [cloves],
  description: [
    "Strong and aromatic whole cloves",
    "Enhances flavor in curries and biryanis",
    "Ideal for tea and spice blends",
    "Naturally rich in essential oils",
    "Carefully sourced for premium quality"
  ],
  createdAt: "2025-03-25T07:17:46.018Z",
  updatedAt: "2025-03-25T07:18:13.103Z",
  inStock: true,
...
},
{
  ...
  image: [black_pepper],
  description: [
    "Bold and aromatic black peppercorns",
    "Adds natural heat and flavor to dishes",
    "Perfect for seasoning and marinades",
    "Freshly packed to retain aroma",
...
},
{
  ...
  image: [salt],
  description: [
    "Refined iodized salt for daily use",
    "Essential ingredient for every kitchen",
    "Free-flowing and easy to use",
    "Enriched with iodine for better nutrition",
